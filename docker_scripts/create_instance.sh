...
# Specify hummingbot image, default to uniworld/hummingbot
read -p "   Enter Hummingbot image name you want to use, ex: uniworld/hummingbot (default = \"uniworld/hummingbot\") >>> " IMAGE_NAME
if [ "$IMAGE_NAME" == "" ]
then
